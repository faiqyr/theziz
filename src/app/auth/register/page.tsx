 ...
 const handleGoogleLogin = async () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        alert("Registrasi Berhasil! Selamat datang di Theziz.");
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-[400px] flex flex-col items-center animate-in fade-in zoom-in duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Start your AI research journey today.</p>
        </div>
        ...
        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="relative group">
              ...
              <input 
                type={showPassword ? "text" : "password"} placeholder="Password (min 6 chars)" required minLength={6}
        ...
        <p className="mt-8 text-sm text-gray-500">
          Already have an account? <Link href="/auth/login" className="text-purple-400 hover:text-purple-300 font-medium transition-colors">Log in</Link>
        </p>
